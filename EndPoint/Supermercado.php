...
class Supermercado
{
    ...
    {
        //$consulta = "SELECT * FROM supermercados";
        $consulta = "SELECT TO_BASE64(Imagen), Nombre, Direccion, Distrito, Telefono FROM `paulojed_lcompras`.`supermercados` ";
    ...
    {
        // Sentencia INSERT
        $comando = "INSERT INTO universidad (Id, Nombre, Direccion, Distrito) VALUES( '$ID','$Nombre','$Direccion','$Distrito')";
